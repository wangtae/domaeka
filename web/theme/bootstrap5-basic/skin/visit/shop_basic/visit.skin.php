...
<section id="visit" class="ft_cnt">
    ...
    <?php if ($is_admin == "super") {  ?><a href="<?php echo G5_ADMIN_URL ?>/visit_list.php" class="btn_admin btn"><i class="fa fa-cog fa-spin fa-fw"></i><span class="visually-hidden">관리자</span></a><?php } ?>
</section>
<!-- } 접속자집계 끝 -->