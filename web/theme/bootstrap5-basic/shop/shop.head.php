    ...
    <div class="main-menu-wrap">
        <div class="container">
            ...
            <div class="category-wrap d-flex justify-content-around">
                ...
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 1) ? 'active' : ''; ?>"><a href="<?php echo shop_type_url(1); ?>" class="primary-menu" title="히트상품"><i class="bi bi-star-fill"></i></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 2) ? 'active' : ''; ?>"><a href="<?php echo shop_type_url(2); ?>" class="primary-menu" title="추천상품"><i class="bi bi-award-fill"></i></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 3) ? 'active' : ''; ?>"><a href="<?php echo shop_type_url(3); ?>" class="primary-menu" title="최신상품"><i class="bi bi-box-seam-fill"></i></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 4) ? 'active' : ''; ?>"><a href="<?php echo shop_type_url(4); ?>" class="primary-menu" title="인기상품"><i class="bi bi-suit-heart-fill"></i></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 5) ? 'active' : ''; ?>"><a href="<?php echo shop_type_url(5); ?>" class="primary-menu" title="할인상품"><i class="bi bi-cash-coin"></i></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (stripos($_SERVER['PHP_SELF'], '_event')) ? 'active' : ''; ?>"><a href="<?php echo G5_THEME_SHOP_URL; ?>/_event.php" class="primary-menu" title="EVENT"><i class="bi bi-balloon-fill"></i></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (stripos($_SERVER['PHP_SELF'], 'couponzone')) ? 'active' : ''; ?>"><a href="<?php echo G5_SHOP_URL; ?>/couponzone.php" class="primary-menu" title="쿠폰존"><i class="bi bi-book-half"></i></a></div>
            </div>
        </div>
    </div>
