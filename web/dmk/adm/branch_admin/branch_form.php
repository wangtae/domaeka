...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
            ...
            if (!isset($branch['br_order_page_skin'])) {
                $branch['br_order_page_skin'] = 'basic_1col';
            }
            ?>
            <select name="br_order_page_skin" id="br_order_page_skin" class="frm_input" onchange="updateSkinDescription(this.value)">
                <?php foreach ($skins as $skin_name => $skin_info) { ?>
                <option value="<?php echo $skin_name; ?>" <?php echo ($branch['br_order_page_skin'] == $skin_name) ? 'selected' : ''; ?>>
                    <?php echo $skin_info['name']; ?>
                </option>
                <?php } ?>
            </select>
            <p class="frm_info" id="skin_description"><?php echo isset($skins[$branch['br_order_page_skin']]['description']) ? $skins[$branch['br_order_page_skin']]['description'] : ''; ?></p>
        </td>
    </tr>
    ...
    function updateSkinDescription(skinName) {
        var descElement = document.getElementById('skin_description');
        if (skinInfos[skinName] && skinInfos[skinName].description) {
            descElement.textContent = skinInfos[skinName].description;
        } else {
