        ...
        <div class="border rounded-lg p-2 flex flex-col" data-category="<?php echo $item['ca_id'] ?>" data-delivery-type="<?php echo htmlspecialchars($item['dmk_delivery_type']) ?>">
            ...
            <div class="flex-1">
                ...
                <div class="flex items-center gap-1">
                    ...
                    ?>
                    <span style="background-color: #fed7aa; color: #c2410c; padding: 1px 4px; border-radius: 9999px; font-size: 0.5rem; display: inline-flex; align-items: center; gap: 1px;">
                        <svg style="width: 8px; height: 8px;" fill="currentColor" viewBox="0 0 20 20">
