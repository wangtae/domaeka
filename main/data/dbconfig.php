...
define('G5_MYSQL_HOST', 'domaeka.com');
define('G5_MYSQL_USER', 'domaeka');
define('G5_MYSQL_PASSWORD', '!domaekaservice@.');
define('G5_MYSQL_DB', 'domaeka');
define('G5_MYSQL_PORT', '3307'); // 기본 MySQL/MariaDB 포트
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '629701aeceedb299d147f6482d1ad6b8'); // 토큰 암호화에 사용할 키
