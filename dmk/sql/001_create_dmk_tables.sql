...
CREATE TABLE `dmk_agency` (
  ...
  `ag_id` varchar(20) NOT NULL COMMENT '대리점 시스템 ID (예: AG001)',
  ...
  `ag_mb_id` varchar(20) NOT NULL COMMENT '대리점 관리자 회원 ID',
  ...
  UNIQUE KEY `uk_dmk_agency_mb_id` (`ag_mb_id`),
...
CREATE TABLE `dmk_branch` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `br_id` varchar(20) NOT NULL COMMENT '지점 시스템 ID (예: BR001)',
  ...
  `br_mb_id` varchar(20) NOT NULL COMMENT '지점 관리자 회원 ID',
  ...
  UNIQUE KEY `uk_dmk_branch_mb_id` (`br_mb_id`),
