...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_s">
            ...
            <?php 
            $order_page_code = $row['br_shortcut_code'] ? $row['br_shortcut_code'] : $row['br_id'];
            ?>
            <a href="<?php echo G5_URL ?>/go/<?php echo $order_page_code ?>" class="btn btn_02" target="_blank">주문페이지</a>
        </td>
    </tr>
