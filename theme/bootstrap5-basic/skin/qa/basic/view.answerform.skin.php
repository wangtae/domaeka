...
<section id="bo_v_ans_form" class="mt-5">
    <?php
    if ($is_admin) {
    ?>
        <h2 class="page-title p-2 mt-3 mb-3"><i class="bi bi-reply-fill"></i> 답변등록</h2>
        ...
        <form name="fanswer" method="post" action="./qawrite_update.php" onsubmit="return fwrite_submit(this);" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="form-write">
                ...
                <div class='form-group mb-2'>
                    <label for="qa_subject" class="visually-hidden">제목</label>
                ...
                <div class="form-group qa_content_wrap <?php echo $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
                    <label for="qa_content" class="visually-hidden">내용<strong>필수</strong></label>
                    <span class="wr_content">
                        <?php echo $editor_html; // 에디터 사용시는 에디터로, 아니면 textarea 로 노출 
                        ?>
                    </span>
                </div>
                <div class="upload-file-wrap mt-2">
                    <div class="input-group mb-1">
                        <label for="bf_file_1" class="input-group-text"><i class="bi bi-download" aria-hidden="true"></i><span class="visually-hidden"> 파일 #1</span></label>
                    ...
                    <div class="input-group">
                        <label for="bf_file_2" class="input-group-text"><i class="bi bi-download" aria-hidden="true"></i><span class="visually-hidden"> 파일 #1</span></label>
                        <input type="file" name="bf_file[2]" id="bf_file_2" title="파일첨부 2 :  용량 <?php echo $upload_max_filesize; ?> 이하만 업로드 가능" class="form-control">
                    </div>
                </div>
            </div>

            <div class="btn-navbar d-flex justify-content-end mt-5 mb-5">
