    ...
    <form name="fpoll" action="<?php echo G5_BBS_URL ?>/poll_update.php" onsubmit="return fpoll_submit(this);" method="post">
        ...
        <section id="poll">
            <div class='poll-title'>
                <h2 class='fs-6 fw-bolder ff-noto text-secondary'>설문조사</h2>
                <?php if ($is_admin == "super") {  ?>
                    <a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" class="btn_admin" title="설문관리"><i class="bi bi-gear-fill"></i><span class="visually-hidden">설문관리</span></a>
                <?php }  ?>
                <a href="<?php echo G5_BBS_URL . "/poll_result.php?po_id={$po_id}&amp;skin_dir=" . urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn-sm btn btn-outline-secondary ms-1 me-1">결과</a>
            </div>
            <div class="poll_con">
