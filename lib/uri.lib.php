...
function get_nginx_conf_rules($return_string = false)
{
    ...
    // Domaeka Custom Rewrites BEGIN
    // Branch URL Rewriting Rule: /main/BR_CODE -> /main/shop/order_page.php?br_id=BR_CODE
    $rules[] = "rewrite ^{$base_path}([0-9a-zA-Z_\\-]+)$ {$base_path}shop/order_page.php?br_id=$1&rewrite=1 break;";
    // Domaeka Custom Rewrites END
