...
$menu['menu500'] = array(
    ...
    array('500110', '매출현황 <i class="fa fa-flag" title="개조"></i>', G5_ADMIN_URL . '/shop_admin/sale1.php', 'sst_order_stats'),
    array('500100', '상품판매순위 <i class="fa fa-flag" title="개조"></i>', G5_ADMIN_URL . '/shop_admin/itemsellrank.php', 'sst_rank'),
    array('500120', '주문내역출력 <i class="fa fa-flag" title="개조"></i>', G5_ADMIN_URL . '/shop_admin/orderprint.php', 'sst_print_order', 1),
    ...
    array('500140', '보관함현황 <i class="fa fa-flag" title="개조"></i>', G5_ADMIN_URL . '/shop_admin/wishlist.php', 'sst_wish'),
