...
if (file_exists(G5_PATH.'/dmk/css/tailwind/admin_tailwind.css')) {
    add_stylesheet('<link rel="stylesheet" href="'.G5_URL.'/dmk/css/tailwind/admin_tailwind.css?ver='.G5_CSS_VER.'">', 101);
}
