...
// 지점 ID 파라미터 가져오기 (실제로는 br_url_code 임)
$br_url_code = isset($_GET['br_id']) ? clean_xss_tags($_GET['br_id']) : '';
...
$url_mapping_sql = " SELECT br_id FROM dmk_branch_url WHERE br_url_code = '$br_url_code' AND br_url_active = 1 ";
...
$br_id = $url_mapping['br_id']; // 실제 br_id
